            ...
            <div class="row pricing-cards">
                <div class="col-md-4 col-sm-12" align="center">
                  <div class="cards-item">
                      <div class="card">
                            <div class="top-banner">Sole Proprietor</div>
                      <div class="card__content">
                          <p  style="color:rgb(57, 145, 204); font-size:18px;font-weight:bold;" class="price-header">Form 1065    Schedule C</p>
                          <br>
						   <p>Federal and One State Filing</br>
Fee's. Additional State</br>
if any will cost.</p>
<p></p>
						
                            <!--<ul>
                                
                                <li>Feature 2 Offered</li>
                                <li>Feature 3 Offered</li>
                                <li>Feature 4 Offered</li>
                                <li>Feature 5 Offered</li>
                            </ul>-->
                ...
                <div class="col-md-4">
                  <div class="cards-item">
                      <div class="card">
                            <div class="top-banner">Partnership-LLC</div>
                      <div class="card__content">
                          <div class="row">
                            <p  style="color:rgb(57, 145, 204); font-size:18px;font-weight:bold;margin-left: 65px;" class="price-header">Form 1065</p>
                          </div>
                          <br>
                            <p>Federal and One State Filing</br>
Fee's. Additional State</br>
...
<p></p>
                ...
                <div class="col-md-4">
                  <div class="cards-item">
                      <div class="card">
                            <div class="top-banner">C Corporation</div>
                      <div class="card__content">
                          <div class="row">
                            <p  style="color:rgb(57, 145, 204); font-size:18px;font-weight:bold;margin-left: 65px;" class="price-header">Form 1120</p>
                          </div>
                          <br>
                            <p>Federal and One State Filing</br>
Fee's. Additional State</br>
